...
PYBIND11_MODULE(pam_mujoco_wrp, m)
{
    ...
    pybind11::class_<pam_mujoco::MujocoConfig>(m, "MujocoConfig")
        ...
        .def_readwrite("extended_graphics",
                       &pam_mujoco::MujocoConfig::extended_graphics)
    ...
    m.def("add_table_contact_free_joint",
          &pam_mujoco::add_table_contact_free_joint);
    m.def("add_robot1_contact_free_joint",
          &pam_mujoco::add_robot1_contact_free_joint);
    m.def("add_robot2_contact_free_joint",
          &pam_mujoco::add_robot2_contact_free_joint);
    m.def("add_pressure_controller",
          &pam_mujoco::add_4dofs_pressure_controller);
